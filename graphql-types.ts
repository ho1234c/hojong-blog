...
export type SitePageFieldsEnum =
  ...
  | 'pluginCreator___pluginOptions____src'
...
export type Unnamed_3_Query = { allMarkdownRemark: { nodes: Array<{ frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'path' | 'title' | 'date' | 'tags'>> }> } };
