...
export type Unnamed_1_Query = { allMarkdownRemark: { nodes: Array<{ frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'path' | 'title' | 'date' | 'tags'>> }> } };
...
export type Unnamed_4_Query = { allMarkdownRemark: { nodes: Array<{ frontmatter?: Maybe<Pick<MarkdownRemarkFrontmatter, 'path' | 'title' | 'date' | 'tags'>> }> } };
