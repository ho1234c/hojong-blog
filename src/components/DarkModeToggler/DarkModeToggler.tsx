  ...
  return (
    <div css={wrapperStyle}>
      <Switch
        ...
        checkedIcon={<LightModeIcon width="20" height="20" style={{ transform: 'translate(5px, 4px)' }} />}
        uncheckedIcon={<DarkModeIcon width="18" height="18" style={{ transform: 'translate(4px, 3px)' }} />}
      />
    </div>
  );
};
